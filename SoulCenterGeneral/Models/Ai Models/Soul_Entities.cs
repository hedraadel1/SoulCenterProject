...
namespace SoulCenterProject
{
    ...
    public class Soul_Entities
    {
        ...
        protected float _ConfidenceScore;
        protected string _AdditionalInfo;
        #endregion
        #region Constructors
        public Soul_Entities() { }
        public Soul_Entities(string EntityType, string EntityValue, float ConfidenceScore, string AdditionalInfo)
        {
        ...
        public virtual float ConfidenceScore
        {
